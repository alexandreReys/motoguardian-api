...
router.get("/deliveryman/totals/date/:deliveryman", deliveryOrderControler.getTotalsByDeliverymanAndDate);
...
router.put("/accept/:IdOrder", deliveryOrderControler.putAcceptOrder);
...
router.put("/rating/:idOrder/:rating", deliveryOrderControler.updateRatingDelivery);
